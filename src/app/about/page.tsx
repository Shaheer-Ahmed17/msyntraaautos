  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-[#f4f0eb] font-sans text-[#0d1c17]">
      ...
      <section className="relative w-full overflow-hidden bg-[#f4f0eb] pt-8 md:pt-12">
        {/* Vertical "OUR PURPOSE" side marker */}
        <div className="pointer-events-none absolute left-8 top-8 z-20 hidden h-[380px] flex-col items-center lg:flex">
          <span className="h-2 w-2 shrink-0 rounded-full border border-[#9e6d48]" />
          <span className="mt-3 flex-1 w-px bg-[#8a9992]/30" />
          <span
            className="mb-3 shrink-0 whitespace-nowrap font-mono text-[10px] uppercase tracking-[0.3em] text-[#8a9992]"
        ...
        <div className="relative z-10 grid min-h-[580px] w-full grid-cols-1 items-stretch lg:min-h-[640px] lg:grid-cols-12">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="z-20 flex flex-col justify-between px-6 py-8 md:px-12 lg:col-span-6 lg:pl-20 lg:pr-6"
          >
            <div>
              <h1 className="font-serif font-light uppercase leading-[1.1] tracking-tight text-[#0d1c17] text-[clamp(1.75rem,4.2vw,2.9rem)]">
                <span className="block whitespace-nowrap">WE BELIEVE</span>
                <span className="block whitespace-nowrap">THE RIGHT CAR</span>
                <span className="block whitespace-nowrap text-[#9e6d48]">
                  CHANGES THE WAY
                </span>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative min-h-[380px] w-full lg:col-span-6 lg:min-h-full"
            style={{
        ...
        >
          <div className="space-y-6 lg:col-span-5">
            ...
            <h2 className="font-serif text-3xl font-light uppercase tracking-wider text-[#0d1c17] md:text-4xl">
              AUTOMOTIVE
              <br />
              IS <span className="text-[#9e6d48]">PERSONAL.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 lg:col-span-8">
            {standards.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="relative flex h-40 w-full overflow-hidden">
                    {/* Solid accent block */}
                    <div
                      className="relative h-full w-[36%] shrink-0"
                      style={{ backgroundColor: item.accent }}
                    />

                    {/* Photo */}
                    <div className="relative h-full flex-1 overflow-hidden bg-black/10">
                      <Image
                        src={item.image}
                        alt={item.title}
                        fill
                    ...
                    {/* Icon overlapping the seam */}
                    <div className="absolute left-[36%] top-6 z-10 flex h-9 w-9 -translate-x-1/2 items-center justify-center rounded-full border border-[#dcd5c9] bg-[#0d1c17] text-[#e7e3dc] transition-transform duration-500 group-hover:scale-105">
